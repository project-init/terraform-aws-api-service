...
|------|-------------|------|---------|:--------:|
| <a name="input_api_target_group_arn"></a> [api\_target\_group\_arn](#input\_api\_target\_group\_arn) | The Target Group ARN for the API (assumes already built in to the traffic management apparatus). | `string` | n/a | yes |
...
| <a name="input_container_port"></a> [container\_port](#input\_container\_port) | The port the api service runs on. | `number` | `9001` | no |
...
| <a name="input_environment"></a> [environment](#input\_environment) | The environment to deploy the api service to. | `string` | n/a | yes |
